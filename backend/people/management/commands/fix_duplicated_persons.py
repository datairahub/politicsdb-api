...
DATA = [
    ...
    [
        "jaime_lamo_espinosa_michel_champourcin",
        "jaime_lamo_espinosa_michels_champourcin",
    ],
    ...
    [
        "javier_maroto_aranzabal",
        "javier_ignacio_maroto_aranzabal",
        "Javier Ignacio Maroto Aranzábal",
    ],
    [
        "soraya_saenz_santamaria_anton",
        "maria_soraya_saenz_santamaria_anton",
